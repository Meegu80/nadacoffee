        ...
        <div className="relative">
            ...
            <section className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-black">
                ...
                <div className="absolute inset-0 z-0">
                    ...
                    <div className="absolute inset-0 w-full h-full overflow-hidden pointer-events-none">
                        <iframe
                            ...
                            src="https://www.youtube-nocookie.com/embed/-6WXSOhcM98?autoplay=1&mute=1&controls=0&showinfo=0&rel=0&loop=1&playlist=RzkfAlV0fEI&modestbranding=1&iv_load_policy=3&cc_load_policy=0&playsinline=1&enablejsapi=1&origin=https://composecoffee.com&html5=1"
                ...
                <div className="relative z-20 text-center px-4 max-w-4xl">
                    ...
                    >
                        <h2 className="text-yellow-400 font-bold text-xl md:text-2xl mb-4 tracking-widest">
                            SINCE 2014
                        </h2>
                        <h1 className="text-white text-5xl md:text-8xl font-black mb-8 leading-tight">
                            커피를 <span className="text-yellow-400">커피답게</span>
                        </h1>
                        <p className="text-gray-300 text-lg md:text-xl mb-12 font-medium">
                            컴포즈커피는 고품질 원두와 타협하지 않는 맛으로<br />
                            모두가 즐길 수 있는 최고의 커피 문화를 만듭니다.
                        </p>
                        <motion.button
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                            className="bg-yellow-400 text-black px-10 py-4 font-bold text-lg rounded-full shadow-lg hover:bg-yellow-300 transition-all"
                        >
                            브랜드 스토리 보기
                        </motion.button>
                    </motion.div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
                        <motion.div
                            ...
                            className="space-y-4"
                        >
                            <h3 className="text-yellow-400 text-6xl font-black italic">11<span className="text-2xl not-italic ml-1">th</span></h3>
                        ...
                        <motion.div
                            ...
                            className="space-y-4"
                        >
                            <h3 className="text-yellow-400 text-6xl font-black italic">3100<span className="text-2xl not-italic ml-1">+</span></h3>
                        ...
                        <motion.div
                            ...
                            className="space-y-4"
                        >
                            <h3 className="text-yellow-400 text-6xl font-black italic">12M<span className="text-2xl not-italic ml-1">+</span></h3>
            ...
            <section className="py-24 bg-gray-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col md:flex-row items-end justify-between mb-16">
                        <div>
                            <span className="text-yellow-400 font-bold tracking-widest">WHAT'S NEW</span>
                            <h2 className="text-4xl md:text-5xl font-black mt-2">지금 가장 핫한 메뉴</h2>
                        </div>
                        <button className="mt-4 md:mt-0 text-gray-400 hover:text-black font-bold flex items-center transition-colors">
...
//                         <iframe
//                             className="absolute top-1/2 left-1/2 w-[300%] h-[300%] -translate-x-1/2 -translate-y-1/2 opacity-70"
//                             src="https://www.youtube-nocookie.com/embed/-6WXSOhcM98?autoplay=1&mute=1&controls=0&showinfo=0&rel=0&loop=1&playlist=-6WXSOhcM98&modestbranding=1&iv_load_policy=3&cc_load_policy=0&playsinline=1&enablejsapi=1&origin=https://composecoffee.com&html5=1"
//                             title="Compose Coffee Background Video"
//                             allow="autoplay; encrypted-media"
//                             frameBorder="0"
//                         />
